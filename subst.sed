s%@srcdir@%/usr/glenda/src/BSDgames%g
s%@install_prefix@%/usr/glenda/src/BSDgames/debian/bsdgames%g
...
s%@dictionary_src@%/usr/glenda/src/BSDgames/temp-dictionary%g
